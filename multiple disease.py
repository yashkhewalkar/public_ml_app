...
diabetes_model = pickle.load(open('C:/Users/prati/OneDrive/Desktop/multiple/yash model/diabetes_model.sav', 'rb'))
heart_model = pickle.load(open('C:/Users/prati/OneDrive/Desktop/multiple/yash model/heart_model.sav', 'rb'))
